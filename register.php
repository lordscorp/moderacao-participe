...
$fatalErr = "Erro de sistema! Contate <a href='mailto:rmgomes@prefeitura.sp.gov.br'>o desenvolvedor</a>.";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        $username_err = "Digite o e-mail de login";
    } else{
        // Prepare a select statement
        $sql = "SELECT id FROM moderadores WHERE username = ?";
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO moderadores (username, password) VALUES (?, ?)";
...
<head>
    ...
    <style type="text/css">
        ...
        .wrapper{ width: 440px; padding: 20px; }
    </style>
</head>
<body>
    <div class="wrapper">
